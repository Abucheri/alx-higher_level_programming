...
"""Defines tests for teh square class."""
import unittest
...
class TestXcoordinate(unittest.TestCase):
    """Tests attr for x coordinate."""
...
class TestYcoordinate(unittest.TestCase):
    """Tests attr for y coordinate."""
...
class TestInstanceAttrOrder(unittest.TestCase):
    """Tests for attr order."""
...
class TestPrintForStdout(unittest.TestCase):
    """Tests for stdout display."""
...
class TestDict(unittest.TestCase):
    """Tests to dictionary conversion."""
