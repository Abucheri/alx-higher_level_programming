...
class TestAttrInitializationOrder(unittest.TestCase):
    """Tests attrs order during initialization."""
...
class TestStdoutPrint(unittest.TestCase):
    """Tests displays."""

    @staticmethod
    def capture_stdout(rect, method):
        """Returns stdout output of rectangle.
