...
class TestToJsonString(unittest.TestCase):
    """Tests for json to string conversion."""
...
class TestCreate(unittest.TestCase):
    """Tests for creating an instance."""
...
class TestLoadFromFileCsv(unittest.TestCase):
    """Tests for loading from CSVs."""

    @classmethod
    def tearDown(self):
        """removes created files."""
        try:
            s.remove("Rectangle.csv")
        except IOError:
            pass
        try:
            os.remove("Square.csv")
