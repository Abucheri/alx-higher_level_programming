...
8. Create a new sentence
	...
	```
9. Easter Egg
	- Write a Python script that prints ___“The Zen of Python”___, by TimPeters, followed by a new line.
...
13. ByteCode -> Python #1
	...
	3           0 LOAD_CONST               1 (98)
                   ...
                   11 RETURN_VALUE
	```
	- Tip: [Python bytecode](https://docs.python.org/3.4/library/dis.html 'Disassembler for Python bytecode')
